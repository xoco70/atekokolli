# Clinica de medicina tradicional Atekokolli
...
## License
All parts of Clinica de medicina tradicional Atekokolli theme are free to use and abuse under the open-source [MIT license](http://opensource.org/licenses/mit-license.php).
